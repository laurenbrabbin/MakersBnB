...
class HostParams
 ...
 # end
  ...
  def invaild_host_params?
    invalid_email?  || weak_password? || name_contains_incorrect_characters? || username_contains_incorrect_characters? || password_contains_incorrect_characters?
